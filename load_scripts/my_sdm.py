...
_TRANSCRIPT_URL = "https://huggingface.co/datasets/distil-whisper/whisper_transcriptions_greedy/resolve/main/ami-sdm/"
...
class AMI(datasets.GeneratorBasedBuilder):
    ...
    def _generate_examples(self, audio_archives, local_extracted_archives_paths, annotation, transcript_files, split,
        ...
        if config != "sdm":
            raise ValueError(
                "This dataset is intended for the sdm split only. Use `distil-whisper/ami-ihm` for the sdm split")
